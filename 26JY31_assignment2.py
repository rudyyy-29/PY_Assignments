...
class Report:
    ...
    def fill_content(self, heading, content):
...
if __name__ == "__main__":
    ...
    # r1 and r2 are my contents
    r1 = Report.create_from_template("project_report", "My Mini Project", "Rudra")
    r1.fill_content("Introduction", "This project shows OOP concepts in Python.")
    r1.fill_content("Result", "The program worked correctly.")
    r1.fill_content("Conclusion", "Decorators and magic methods make code flexible.")

    # ---- Creating a second report normally ----
    r2 = Report("Attendance Report", "Rudra")
    r2.add_section("Attendance", "92% attendance this month.")

    # ---- Magic methods in action ----
    print("---- Print String using __str__ ----")
    print(r1)
    print(" ")

    print("---- Gives length/number of sections in r1 using __len__ ----")
    print(len(r1))
    print(" ")

    print("---- Gives items/conents of r1[2] uses __getitem__ ----")
    print(r1[2])
    print(" ")
    ...
    print("\n\nfor Author Report--------------------------- with @bold and @add_border decorators ----\n")
    print(r1.summary())
    print(" ")
    print("for Attendace Report-----------------------------with @bold and @add_border decorators ----\n")
    print(r2.summary())